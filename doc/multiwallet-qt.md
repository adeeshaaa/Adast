...
In order to support loading of multiple wallets in Adast-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Adast.cpp.
...
Changes to Adast.cpp
----------------------
Adast.cpp is the entry point into Adast-qt, and as such, will require some minor modifications to provide hooks for
