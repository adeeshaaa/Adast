...
This mechanism has been integrated into Bitcore-Node-Adast which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Adast-Project/insight-api-Adast#web-socket-api](https://github.com/Adast-Project/insight-api-Adast#web-socket-api) 
* API: [https://github.com/Adast-Project/insight-api-Adast#swifttx-transactions](https://github.com/Adast-Project/insight-api-Adast#swifttx-transactions) 
...
By default, the Adast Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Adast Core daemon:
