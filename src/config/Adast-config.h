/* src/config/Adast-config.h.  Generated from Adast-config.h.in by configure.  */
/* src/config/Adast-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.Adast.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Adast Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Adast Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Adast"
