                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Adast Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Adast address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Adast: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Adast Core"), this);
    aboutAction->setStatusTip(tr("Show information about Adast Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Adast"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Adast addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Adast addresses"));
    ...
    openAction->setStatusTip(tr("Open a Adast: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Adast Core help message to get a list with possible Adast command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Adast Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Adast network", "", count));
}
...
{
    QString strTitle = tr("Adast Core"); // default title
