...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeAdast = new QSpinBox(tabMain);
        anonymizeAdast->setObjectName(QStringLiteral("anonymizeAdast"));
        anonymizeAdast->setMinimum(100);
        anonymizeAdast->setMaximum(100000);
        anonymizeAdast->setSingleStep(100);
        anonymizeAdast->setValue(1000);

        horizontalLayout->addWidget(anonymizeAdast);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Adast after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Adast on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Adast to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Adast client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Adast network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Adast.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/Adast-project/Adast-project-translations", 0));
