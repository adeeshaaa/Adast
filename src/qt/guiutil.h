...
/** Utility functions used by the Adast Qt UI.
 */
namespace GUIUtil
{
...
// Render Adast addresses in monospace font
...
// Parse "Adast:" URI into recipient object, return true on successful parsing
