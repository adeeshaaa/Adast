...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Adast features */
        {"Adast", "masternode", &masternode, true, true, false},
        {"Adast", "listmasternodes", &listmasternodes, true, true, false},
        {"Adast", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Adast", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Adast", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Adast", "masternodedebug", &masternodedebug, true, true, false},
        {"Adast", "startmasternode", &startmasternode, true, true, false},
        {"Adast", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Adast", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Adast", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Adast", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Adast", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Adast", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Adast", "mnbudget", &mnbudget, true, true, false},
        {"Adast", "preparebudget", &preparebudget, true, true, false},
        {"Adast", "submitbudget", &submitbudget, true, true, false},
        {"Adast", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Adast", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Adast", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Adast", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Adast", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Adast", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Adast", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Adast", "checkbudgets", &checkbudgets, true, true, false},
        {"Adast", "mnsync", &mnsync, true, true, false},
        {"Adast", "spork", &spork, true, true, false},
        {"Adast", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Adast", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Adastd, or the -server option to Adast-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Adast-cli " + methodname + " " + args + "\n";
}
