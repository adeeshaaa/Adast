...
// Copyright (c) 2016-2017 The Adast developers
...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_14_NEW_PROTOCOL_ENFORCEMENT_1   ) r = SPORK_14_NEW_PROTOCOL_ENFORCEMENT_1_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_14_NEW_PROTOCOL_ENFORCEMENT_1"   ) return SPORK_14_NEW_PROTOCOL_ENFORCEMENT_1;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_14_NEW_PROTOCOL_ENFORCEMENT_1   ) return "SPORK_14_NEW_PROTOCOL_ENFORCEMENT_1";
